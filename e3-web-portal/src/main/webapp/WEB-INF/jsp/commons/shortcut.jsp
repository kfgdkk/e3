    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://localhost:8084/page/login?returnUrl=http://localhost:8081/index">请登录</a>
      	</span>
      	<a href="http://localhost:8084/page/register?returnUrl=http://localhost:8084/page/login">免费注册</a>
      </li>
