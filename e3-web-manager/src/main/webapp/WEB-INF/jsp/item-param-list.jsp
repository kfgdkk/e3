...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/e3-web-manager/item/param/list',method:'get',pageSize:30,toolbar:itemParamListToolbar">
    <thead>
        <tr>
        	<th data-options="field:'ck',checkbox:true"></th>
        	<th data-options="field:'id',width:60">ID</th>
        	<th data-options="field:'itemCatId',width:80">商品类目ID</th>
        	<th data-options="field:'itemCat.name',width:100">商品类目</th>
            <th data-options="field:'paramData',width:300,formatter:E3.formatItemParamData">规格(只显示分组名称)</th>
...
<script>
    ...
    var itemParamListToolbar = [{
        ...
        handler:function(){
        	E3.createWindow({
        		url : "/e3-web-manager/item-param-add",
        	});
        }
    },{
        text:'编辑',
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定删除ID为 '+ids+' 的商品规格吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
                	$.post("/e3-web-manager/item/param/delete",params, function(data){
            			if(data.status == 200){
